            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {products.phones.map((product) => (
                        <div
                            key={product.id}
                            className="group relative overflow-hidden rounded-none border border-white/10 hover:border-white/30 transition-all duration-500 bg-black"
                        >
                            {/* Product Image */}
                            ...
                            <div className="p-8 space-y-6">
                                ...
                                {/* Features with dot matrix style */}
                                <div className="space-y-2">
